...
Nhằm cung cấp một sự hiểu biết toàn diện, xuyên suốt về phương pháp luận DevOps và cách triển khai thực tế trên nền tảng AWS. Hội thảo này được thiết kế để trang bị cho các nhóm phát triển và vận hành kiến thức nhằm xây dựng, triển khai và giám sát các ứng dụng có khả năng mở rộng và độ tin cậy cao một cách hiệu quả, thông qua việc tận dụng các dịch vụ AWS cho CI/CD, Hạ tầng dưới dạng Mã (IaC), container hóa và quan sát hệ thống.
